...
public class Topic_07_08_Textbox_TextArea_Exercise extends Common {
  ...
  public void tc01() {
    ...
    String contactInformation = driver
        .findElement(By.xpath("//h3[text()='Contact Information']/parent::div/following-sibling::div/p")).getText();
    ...
    Assert
        .assertTrue(driver.findElement(By.cssSelector(".page-title > h2")).getText().contains("THIS IS DEMO SITE FOR"));
  }
  ...
  public void tc02() {
    ...
    driver
        .findElement(By.xpath("//h6[text()='Assigned Immigration Records']/following-sibling::button[text()=' Add ']"))
        .click();
    common.sleepInSecond(3);
