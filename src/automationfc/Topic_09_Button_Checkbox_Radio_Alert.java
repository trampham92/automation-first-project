...
public class Topic_09_Button_Checkbox_Radio_Alert {
    ...
    public void tc02DefaultCheckboxOrRadioButtonSingle() {
    	...
    	WebElement dualZoneAirCheckbox = driver.findElement(By.xpath("//label[text()='Dual-zone air conditioning']/preceding-sibling::input"));
    ...
    public void tc03DefaultCheckboxOrRadioButtonMultiple() {
    	...
    	WebElement summerRadioButton = driver.findElement(By.xpath("//label[contains(text(), 'Summer')]/preceding-sibling::div/input"));
    	...
    	List<WebElement> listConfigCheckbox = driver.findElements(By.xpath("//example-viewer[@id='checkbox-configurable']//input[@class='mdc-checkbox__native-control']"));
    	for (WebElement checkbox : listConfigCheckbox) {
    		if(listCheckedText.contains(checkbox.findElement(By.xpath(".//parent::div/following-sibling::label")).getText())) {
				//Checked
