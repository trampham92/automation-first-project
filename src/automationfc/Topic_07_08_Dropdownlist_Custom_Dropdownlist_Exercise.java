...
public class Topic_07_08_Dropdownlist_Custom_Dropdownlist_Exercise extends Common {
  ...
  public void tc03JQuery() {
    ...
    Assert.assertEquals(driver.findElement(By.cssSelector("#speed-button span.ui-selectmenu-text")).getText(),
        "Medium");
  ...
  public void tc05VueJs() {
    ...
    common.sleepInSecond(3);
    selectItem(By.cssSelector("#app div>li"), By.cssSelector("ul[data-v-3ec2ada6] a[data-v-3ec2ada6]"),
        "Second Option");
  ...
  public void tc06Editable() {
    ...
    common.sleepInSecond(3);
    inputAndSelectItem(By.cssSelector("input[class='search']"), By.cssSelector("#root div[role='option'] span.text"),
        "Belgium");
